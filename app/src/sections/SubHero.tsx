...
const SubHero = () => {
  ...
  // Stats data
  const stats = [
    { value: 25, suffix: '+', label: t('subhero.stats.projects') },
    { value: 50, suffix: 'K+', label: t('subhero.stats.stars') },
    { value: 100, suffix: 'K+', label: t('subhero.stats.readers') },
    { value: 10, suffix: 'K+', label: t('subhero.stats.members') },
  ];

  // Build countUp hooks for each stat
  const statCounters = stats.map((stat) =>
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-[#696969] text-lg leading-relaxed mb-6">
              {t('subhero.paragraph1')}
            </p>
            <p className="text-[#696969] text-lg leading-relaxed mb-6">
              {t('subhero.paragraph2')}
            </p>
            <a
              href="#about"
              onClick={(e) => {
      ...
      <div ref={statsRef} className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 mt-20 lg:mt-32">
        ...
        >
          {stats.map((stat, index) => (
            <div key={index} className={`p-6 ${index < stats.length - 1 ? 'border-r border-gray-200' : ''}`}>
