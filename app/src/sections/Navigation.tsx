...
import { ShoppingBag, X, Search, Instagram, Facebook, Twitter, Linkedin, Github } from 'lucide-react';
          ...
          <div className="flex-1 flex flex-col justify-center items-center px-8 lg:px-20">
            ...
            <nav className="flex flex-col items-center gap-6">
              {[
                ...
                { label: t('nav.resources'), href: '#products' },
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {cartItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-[#696969] text-lg">{t('nav.cartEmpty')}</p>
                  <button
                    onClick={() => setIsCartOpen(false)}
