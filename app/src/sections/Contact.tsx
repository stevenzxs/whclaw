        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-16">
          ...
          >
            ...
            <div className="space-y-6 mb-12">
              ...
              <div className="flex items-center gap-4">
                <Github size={20} strokeWidth={1.5} className="text-[#8b6d4b]" />
                <div>
                  <span className="block text-xs uppercase tracking-wider opacity-60 mb-1">{t('contact.githubLabel')}</span>
                  <a href={`https://${t('contact.github')}`} target="_blank" rel="noopener noreferrer" className="font-light hover:text-[#8b6d4b] transition-colors">
                    {t('contact.github')}
                  </a>
                </div>
              </div>
